...
const DotField = memo(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = "rgba(16, 185, 129, 0.15)", /* Translucent emerald */
  gradientTo = "rgba(20, 184, 166, 0.1)",    /* Translucent teal */
  glowColor = "rgba(16, 185, 129, 0.05)",    /* Soft green mouse glow */
  ...rest
}: DotFieldProps) => {
